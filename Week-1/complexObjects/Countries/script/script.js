...
southAsianCountries = countries
  .filter((country) => country.region === "South Asia") // Filter for South Asian countries
  .map(normalizeCountry); // Normalize each country

// Calculate total population of South Asia
